...
struct ReleasedRecordingsView: View {
    ...
    static let mock: [ReleasedRecording] = {
        ...
        return [
            ...
            // container (task #1049), so "Save to Photos" must say so up front
            // instead of downloading the whole file and failing at the end.
            // Last in the list so it doesn't shift the other cards' geometry.
            ReleasedRecording(
                ...
                releasedBy: "jing@everbot.org", angleCount: 1,
